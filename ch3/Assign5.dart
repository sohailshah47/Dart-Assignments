...
// principalAmount*=(1 + interestRate)^timePeriod ;
// int compoundInterest=principalAmount;
// principalAmount-=compoundInterest;
int compoundInterest = principalAmount * (1 + interestRate)^timePeriod ;
print("Calculated compound Interest= $compoundInterest");
}